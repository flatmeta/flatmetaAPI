          ...
          <div class="row g-3 mb-3">
            ...
            <div class="col-sm-6 col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  <h6>Total Screens</h6>
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{ "0" }},"decimalPlaces":0,"suffix":""}'>{{ "0" }}</div><a class="fw-semi-bold fs--1 text-nowrap" href="">All Screening<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  ...
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-success" data-countup='{"endValue":{{ "0" }},"prefix":""}'>{{ "0" }}</div><a class="fw-semi-bold fs--1 text-nowrap" href="">All Exercises<span class="fas fa-angle-right ms-1" data-fa-transform="down-1"></span></a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-6 col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  ...
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-info" data-countup='{"endValue":{{ "0" }},"decimalPlaces":0,"suffix":""}'>{{ "0" }}</div>
                </div>
              </div>
            </div>
            <div class="col-sm-6 col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <div class="card-body position-relative">
                  <h6>Total Completed Exercises</h6>
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-success" data-countup='{"endValue":{{ "0" }},"decimalPlaces":0,"suffix":""}'>{{ "0" }}</div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card overflow-hidden" style="min-width: 12rem">
                ...
                <!--/.bg-holder-->
                <div class="card-body position-relative">
                  <h6>Total Screen Pain</h6>
                  <div class="display-4 fs-4 mb-2 fw-normal font-sans-serif text-warning" data-countup='{"endValue":{{ "0" }},"prefix":""}'>{{ "0" }}</div>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="card-body">
                  <div class="row flex-between-center g-0">
                    <div class="col-6 d-lg-block flex-between-center">
                      <h6 class="mb-2 text-900">On Trial Users</h6>
                      <h4 class="fs-3 fw-normal  mb-0 text-warning">{{ "0" }}</h4>
                    </div>
            ...
            <div class="col-md-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row flex-between-center g-0">
                    <div class="col-6 d-lg-block flex-between-center">
                      <h6 class="mb-2 text-900">Active Subscriptions</h6>
                      <h4 class="fs-3 fw-normal  mb-0 text-info">{{ "0" }}</h4>
                    </div>
                    <div class="col-auto h-100">
                      <div style="height:50px;min-width:80px;" data-echarts='{"xAxis":{"show":false,"boundaryGap":false},"series":[{"data":[3,7,6,8,5,12,11],"type":"line","symbol":"none"}],"grid":{"right":"0px","left":"0px","bottom":"0px","top":"0px"}}'></div>
                    </div>
            ...
            <div class="col-md-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row flex-between-center g-0">
                    <div class="col-6 d-lg-block flex-between-center">
                      <h6 class="mb-2 text-900">Expired Subscriptions</h6>
                      <h4 class="fs-3 fw-normal  mb-0 text-success">{{ "0" }}</h4>
                    </div>
                    <div class="col-auto h-100">
                      <div style="height:50px;min-width:80px;" data-echarts='{"xAxis":{"show":false,"boundaryGap":false},"series":[{"data":[3,7,6,8,5,12,11],"type":"line","symbol":"none"}],"grid":{"right":"0px","left":"0px","bottom":"0px","top":"0px"}}'></div>
                    </div>
              ...
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-center">
                    <div class="col-auto">
                      <h6 class="mb-0">Total Screenings Completed</h6>
                    </div>
                  </div>
                </div>
                <div class="card-body h-100 pe-0">
                  <canvas class="max-w-100" id="Total_Screening"></canvas>
                </div>
              </div>
            </div>
            ...
            <div class="col-xxl-6">
              <div class="card">
                <div class="card-header">
                  <div class="row flex-between-center">
                    <div class="col-auto">
                      <h6 class="mb-0">Total Exercises Completed</h6>
                    </div>
                  </div>
                </div>
                <div class="card-body h-100 pe-0">
                  <canvas class="max-w-100" id="Total_Exercises"></canvas>
                </div>
              </div>
            </div>
          </div>
